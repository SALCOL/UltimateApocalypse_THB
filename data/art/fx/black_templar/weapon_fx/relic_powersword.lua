fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "unit_melee_powersword_halo_combo",
				},
				property_01 =  
				{
					name = "Fx2",
	...
	{
		effect = "root>unit_melee_powersword_halo_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>unit_melee_powersword_halo_combo>unit_melee_powersword_halo_beam",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>unit_melee_powersword_halo_combo>unit_melee_powersword_halo_beam_2",
		fx =  
		{
			properties =  
			{
