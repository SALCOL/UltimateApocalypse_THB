fxtypes =  
{
	...
	{
		effect = "root>__fxtool_private_copy>reinforce_hammer_lightning_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>reinforce_hammer_lightning_combo>unit_melee_hammer_lightning_spray_3",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>reinforce_hammer_lightning_combo>unit_melee_hammer_lightning_spray_3>unit_melee_powersword_lightning_hit_beam_3",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>reinforce_hammer_lightning_combo>unit_melee_hammer_glow_ring",
		fx =  
		{
			properties =  
			{
