fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_05 =  
				{
					name = "FX6",
					type = "VARTYPE_STRING",
					value = "inferno_cannon_end_exit_combo",
				},
				property_06 =  
				{
					name = "FX7",
	...
	{
		effect = "root>inferno_cannon_end_exit_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>inferno_cannon_end_exit_combo>env_building_fire_med_ring_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>inferno_cannon_end_exit_combo>env_building_fire_med_ring_spray>env_building_fire_med_ring",
		fx =  
		{
			properties =  
			{
