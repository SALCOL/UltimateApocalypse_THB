fxtypes =  
{
	...
	{
		effect = "root>__fxtool_private_copy>lightning_beam_1",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>doombolt_impact_unit",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>doombolt_impact_unit>spark_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>doombolt_impact_unit>spark_combo>possession_trail_hit",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/GENERIC_TRAIL_BLUE.TGA",
				},
				property_04 =  
				{
					name = "ColourHead",
	...
	{
		effect = "root>doombolt_impact_unit>spark_combo>possession_trail_dark",
		fx =  
		{
			properties =  
			{
