fxtypes =  
{
	...
	{
		effect = "root>black_particles_burst",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>black_particles_burst>default_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>black_particles_burst>default_spray>default_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES/ILE_SPRITES/A_SPARK03.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>default_spray>default_beam",
		fx =  
		{
			properties =  
			{
