fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "bolt_of_change_projectile",
				},
				property_01 =  
				{
					name = "Fx2",
	...
	{
		effect = "root>bolt_of_change_projectile",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>bolt_of_change_projectile>bolt_of_change_projectile",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>bolt_of_change_projectile>bolt_of_change_projectile>default_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "SKINNIE_TEXTURES/CHAOS_VORTEX.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>__fxtool_private_copy>bolt_of_change_projectile",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>bolt_of_change_projectile>default_ring",
		fx =  
		{
			properties =  
			{
