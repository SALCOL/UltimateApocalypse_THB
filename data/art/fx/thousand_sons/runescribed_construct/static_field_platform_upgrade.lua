fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_04 =  
				{
					name = "FX5",
					type = "VARTYPE_STRING",
					value = "platform_glow_no_lighting",
				},
				property_05 =  
				{
					name = "FX6",
	...
	{
		effect = "root>talos_deathspark>default_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>talos_deathspark>default_spray>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>talos_deathspark>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>talos_deathspark>__fxtool_private_copy>default_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>platform_glow_no_lighting",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>platform_glow_no_lighting>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
