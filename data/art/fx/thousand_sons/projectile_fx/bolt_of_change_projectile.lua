fxtypes =  
{
	...
	{
		effect = "root>bolt_of_change_projectile>default_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "THOUSAND_SONS/TEXTURES/VORTEX.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "THOUSAND_SONS/TEXTURES/FLARE2.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
