fxtypes =  
{
	...
	{
		effect = "root>deceiver_teleport>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>deceiver_teleport>__fxtool_private_copy>big_mek_mega_beam_1",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>deceiver_teleport>__fxtool_private_copy>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "BIG_MEK_MEGA_MUZZLE_GLOW3.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
