fxtypes =  
{
	...
	{
		effect = "root>flame_bright_spray>bolterfire",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>flame_bright_spray>bolterfire>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "KWE/TEXTURES_NEW/GLOW_RINGS/DEATH_PULSE_RING_2.DDS",
				},
				property_04 =  
				{
					name = "Offset",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "KWE/TEXTURES_NEW/GLOW_RINGS/KNARLOC_FOOT_STOMP.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
