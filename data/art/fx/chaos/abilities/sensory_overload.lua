fxtypes =  
{
	...
	{
		effect = "root>default_spray>working",
		fx =  
		{
			properties =  
			{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES/ILE_SPRITES/A_RADIALBITS.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>working>default_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>default_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>default_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>__fxtool_private_copy>default_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>__fxtool_private_copy>__fxtool_private_copy>default_combo>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
