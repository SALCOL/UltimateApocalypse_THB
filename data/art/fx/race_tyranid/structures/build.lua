fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_06 =  
				{
					name = "FX7",
					type = "VARTYPE_STRING",
					value = "consumption_field_vlarge",
				},
				property_07 =  
				{
					name = "FX8",
	...
	{
		effect = "root>consumption_field_vlarge",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>consumption_field_vlarge>default_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>consumption_field_vlarge>default_spray>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES/ILE_SPRITES/A_SPLASH.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
