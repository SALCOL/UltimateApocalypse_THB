fxtypes =  
{
	...
	{
		effect = "root>particles_spray_gravwell>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>particles_spray_gravwell>__fxtool_private_copy>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "WITCH_HUNTER_FX/ABILITIES_FX/MUZZLE_TRACER_GOLD_01.DDS",
				},
				property_04 =  
				{
					name = "ColourHead",
