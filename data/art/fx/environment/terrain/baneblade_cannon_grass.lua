fxtypes =  
{
	...
	{
		effect = "root>veh_grass>smoke_snow_ring_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>veh_grass>smoke_snow_ring_combo>veh_ground_smoke_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>veh_grass>smoke_snow_ring_combo>veh_ground_snow_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/ALPHA_RINGS/SNOW_CLOUD_1.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
