fxtypes =  
{
	...
	{
		effect = "root>snowfall_hvy_1>snow_flake_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>sleet_1>lightning_beam_1_red",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/BEAMS/RAIN_STREAK.DDS",
				},
				property_04 =  
				{
					name = "Offset",
