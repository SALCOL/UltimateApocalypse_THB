fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "snowfall_hvy_2",
				},
				property_01 =  
				{
					name = "Fx2",
					type = "VARTYPE_STRING",
					value = "snowfall_hvy_3",
				},
				property_02 =  
				{
					name = "FX3",
	...
	{
		effect = "root>snowfall_hvy_2>snow_flake_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>snowfall_hvy_3>snow_flake_ring",
		fx =  
		{
			properties =  
			{
